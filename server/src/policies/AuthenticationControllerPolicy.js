...
module.exports = {
    ...
    signup_student(req, res, next) {
        const schema = {
            ...
            birthDate_visibility: Joi.required(),
            gender: Joi.string().required(),
            gender_visibility: Joi.required(),
            country: Joi.string().required(),
            country_visibility: Joi.required(),
            city: Joi.string().required(),
            city_visibility: Joi.required(),
            courseId: Joi.number().required(),
            enrollmentDate: Joi.string().required(),
            graduationDate: Joi.string(),
            type: Joi.string().required(),
            type_visibility: Joi.required(),
            mecNumber: Joi.string().required(),
            mecNumber_visibility: Joi.required(),
            company: Joi.string(),
    ...
    signup_staff(req, res, next) {
        const schema = {
            ...
            workingLocation_visibility: Joi.required(),
            startDate: Joi.string(),
            startDate_visibility: Joi.required(),
            endDate: Joi.string(),
            endDate_visibility: Joi.required(),
            mecNumber: Joi.string().required(),
            mecNumber_visibility: Joi.required(),
            company: Joi.string(),
            companyType: Joi.string(),
