          ...
          <v-card>
                ...
                <v-container grid-list-md>
                  <v-layout wrap>
                    ...
                    <v-flex xs12 md6>
                      ...
                      <v-flex xs2>
                      <v-btn flat color="blue-grey lighten-3" @click="endDate=''"> <v-icon> clear </v-icon> </v-btn>             
                      </v-flex>
                      </v-layout>
                    </v-flex>
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" flat @click.native="() => { 
                  warningDialog=true
                  if(updatingCourse){
                    warningAction=updateCourse
                    warningTitle='Are you sure you want to update the course?'
                  }else{
                    warningAction=createCourse
                    warningTitle='Are you sure you want to create the course?'
                  }
                }" :disabled="!formValid">
                  ...
                  <v-toolbar v-for="course in courses" :key="course.id">
                    ...
                    <v-toolbar-items>
                      ...
                      <v-btn flat color="error" @click="() => {
                          ...
                          warningDialog=true
                          warningAction=deleteCourse 
                          warningTitle=`Are you sure you want to delete \'${course.name}\' ?`}">
