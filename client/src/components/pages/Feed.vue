      ...
      contents: [
        {
          ...
          description:
            "Mauris hendrerit tristique mi. Praesent tristique nulla nisi, vitae viverra enim gravida laoreet. Donec condimentum lacus volutpat, laoreet sapien in, congue nunc. Vestibulum commodo suscipit nisi. Proin suscipit diam ac nibh lobortis viverra. Cras placerat pulvinar nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit."
        },
...

        {
          ...
          avatar: "https://www.w3schools.com/howto/img_avatar.png",
          description:
            "Vivamus eleifend metus semper risus eleifend eleifend. In tristique vel magna eget scelerisque. Cras quis venenatis augue. Nulla facilisi. Sed in feugiat mi, in pretium ante."
        },

        {
          ...
          avatar: "https://www.w3schools.com/howto/img_avatar.png",
          description:
            "Integer pulvinar sem a vulputate interdum. Duis in lorem mi. Nullam eu odio sit amet nibh aliquet posuere eget vitae nulla. Integer congue auctor risus, sit amet placerat risus blandit in."
        },

        {
          ...
          avatar: "https://www.w3schools.com/howto/img_avatar.png",
          description:
            "Donec bibendum hendrerit velit, ac maximus ex mattis id. In luctus est nec sodales pretium. Nulla bibendum nisi quis mauris tempus, id vulputate turpis venenatis. Nullam eu libero imperdiet, mattis magna in, sollicitudin nisi. Nullam auctor ipsum orci. Sed ac ex erat."
        }
      ]
    };
  },
    ...
    return {
      contents: [
...

        {
          ...
          date: "31-7-2018",
          avatar:
            "http://eventsbyambrosia.com/wp-content/uploads/2016/06/events.jpg",
          description:
            "Pellentesque semper tempor pulvinar. Curabitur sollicitudin luctus sapien, at ultrices arcu pellentesque sit amet. Pellentesque vitae justo interdum, mollis quam vel, eleifend orci. Aliquam cursus turpis mi, ac ultrices orci lacinia vel. Suspendisse bibendum tellus in dui mattis condimentum non non lectus. Nullam pellentesque, lorem in tristique auctor, metus urna maximus velit, ac tempus nunc lacus vitae ligula. Vestibulum consequat velit vitae cursus pretium."
        },
  ...
  data() {
    return {
      ...
      nav_tabs: [
        { name: "Feed", id: 1 },
        { name: "Events", id: 2 },
        { name: "Job Opportunities", id: 3 },
        { name: "Newsletter", id: 4 },
        { name: "News", id: 5 },
        { name: "Education", id: 6 }
      ]
    };
